...
const StartFunc = ({ }) => {
  ...
  let LocalinDataToInsert = {GroupName : LocalCoumnGroupName,GroupTelugu : LocalCoumnGroupTelugu,VegetableName : LocalCoumnVegetableName,VegetableImage : LocalCoumnVegetableImage,VegetableTelugu : LocalCoumnVegetableTelugu,VegetableRate : LocalCoumnVegetableRate};
