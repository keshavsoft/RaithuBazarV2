...
const StartFunc = ({ }) => {
  ...
  let LocalinDataToInsert = {GroupFK : LocalCoumnGroupFK,GroupTelugu : LocalCoumnGroupTelugu,VegetableName : LocalCoumnVegetableName,VegetableImage : LocalCoumnVegetableImage,VegetableTelugu : LocalCoumnVegetableTelugu,VegetableRate : LocalCoumnVegetableRate};
